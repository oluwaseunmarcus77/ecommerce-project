    ...
    <div className="pt-4 bg-white top-0 sticky">
      <div className="container">
        <div className="flex justify-between items-center">
          <div className="text-4xl font-bold">£co Store</div>
          <div className="lg:flex hidden w-full max-w-[500px]">
            <input
              className="border-2 border-pink px-6 py-2 w-full"
              type="text"
              placeholder="Search for products..."
            />

            <div className="bg-pink text-white text-[26px] grid place-items-center px-4">
              <BsSearch />
            </div>
          </div>
          ...
          <div className="flex gap-4 md:gap-8 items-center">
            <div className="md:flex hidden gap-3">
              <div
                className="rounded-full border-2 border-pink-300 text-gray-500 text-[32px]
