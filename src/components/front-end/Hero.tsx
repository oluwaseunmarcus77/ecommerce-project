  ...
  return (
    <div className="bg-[£E3EDF6] mt-4">
      <div className="container grid md:grid-cols-2 py-8">
        <div className="flex items-center">
          <div className="max-w-[450px] space-y-4">
            ...
            <h1 className="text-topHeadingPrimary font-bold text-4xl md:text-5xl">
              The best Apple iPad collection 2024
            </h1>
            ...
            <a
              className="inline-block bg-white rounded-md px-6 py-3 hover:bg-pink hover:text-white"
              href="#"
            >
              Shop Now
            </a>
        ...
        <div>
          <img className="ml-auto" src="/ipad.png" alt="hero" />
        </div>
      </div>
    </div>
  )
